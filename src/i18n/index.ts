...
export const messages = {
  ...
  // Family (Aile Planı — Duolingo modeli in-app davet sistemi)
  family: {
    title:                  { tr: 'Aile Planı', en: 'Family Plan' },
    you:                    { tr: 'Sen', en: 'You' },
    owner:                  { tr: 'Sahip', en: 'Owner' },
    loading:                { tr: 'Yükleniyor...', en: 'Loading...' },
    full:                   { tr: 'Aile dolu (5/5 üye)', en: 'Family is full (5/5)' },
    inviteTitle:            { tr: 'Aileni davet et', en: 'Invite your family' },
    inviteSubtitle:         { tr: '5 üyeye kadar Premium’u paylaş', en: 'Share Premium with up to 5 members' },
    inviteCta:              { tr: 'Davet Kodu Üret', en: 'Generate Invite Code' },
    ...
    ownerStatus:            { tr: 'Aile Sahibisin', en: 'You are the family owner' },
    statusActive:           { tr: 'Aktif', en: 'Active' },
    statusExpired:          { tr: 'Süresi doldu', en: 'Expired' },
    statusPaused:           { tr: 'Beklemede', en: 'Paused' },
    memberCount:            { tr: '{count}/{max} üye', en: '{count}/{max} members' },
    notInFamily:            { tr: 'Aile planın yok', en: 'No family plan' },
    notInFamilySubtitle:    { tr: 'Premium’u sevdiklerinle paylaş', en: 'Share Premium with your loved ones' },
    needFamilyPlanCta:      { tr: 'Aboneliklere Git', en: 'View Plans' },
    memberOf:               { tr: '{ownerName} ailesinin üyesisin', en: 'You are in {ownerName}’s family' },
    settingsLinkTitle:      { tr: 'Aile Planı', en: 'Family Plan' },
    settingsLinkSubtitle:   { tr: 'Davet kodu üret, üyeleri yönet veya bir aileye katıl', en: 'Generate invite, manage members or join a family' },
    buyOwnTitle:            { tr: 'Kendi aile planını al', en: 'Get your own family plan' },
    join: {
      title:                { tr: 'Davet kodun mu var?', en: 'Have an invite code?' },
      subtitle:             { tr: 'Aile sahibinden aldığın kodu gir, Premium aileye ücretsiz katıl.', en: 'Enter the code from the family owner to join Premium for free.' },
      placeholder:          { tr: 'KOD (örn. V6MV54)', en: 'CODE (e.g. V6MV54)' },
      cta:                  { tr: 'Aileye Katıl', en: 'Join Family' },
      or:                   { tr: '— veya —', en: '— or —' },
      loginRequired:        { tr: 'Davet kodu girmek için önce giriş yapmalısın.', en: 'Sign in first to enter an invite code.' },
      loginCta:             { tr: 'Giriş Yap', en: 'Sign In' },
    },
    accept: {
      title:                { tr: 'Vogel Premium Ailesi', en: 'Vogel Premium Family' },
      subtitle:             { tr: 'Kabul edersen tüm Premium özelliklere erişebilirsin', en: 'Accept to unlock all Premium features' },
      cta:                  { tr: 'Aileye Katıl', en: 'Join Family' },
      skip:                 { tr: 'Daha Sonra', en: 'Maybe Later' },
      success:              { tr: 'Aileye katıldın! 🎉', en: 'You joined the family! 🎉' },
      errors: {
        expired:            { tr: 'Davet kodunun süresi dolmuş', en: 'Invite code has expired' },
        full:               { tr: 'Bu aile planı dolu (5/5)', en: 'This family is full (5/5)' },
        alreadyIn:          { tr: 'Zaten başka bir aile planındasın', en: 'You are already in another family' },
        alreadyPremium:     { tr: 'Zaten aktif Premium aboneliğin var', en: 'You already have an active Premium subscription' },
        unknown:            { tr: 'Davet kabul edilemedi', en: 'Failed to accept invite' },
      },
    },
    leave: {
      cta:                  { tr: 'Aileden Ayrıl', en: 'Leave Family' },

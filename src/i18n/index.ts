...
export const messages = {
  ...
  family: {
    ...
    shareMessage:           { tr: '🐦 Vogel Premium ailem seni davet ediyor! Bu kodla katıl: {code} → {link}', en: '🐦 Join my Vogel Premium family! Code: {code} → {link}' },
    ...
    settingsLinkSubtitle:   { tr: 'Davet kodu üret veya üyeleri yönet', en: 'Generate invite or manage members' },
    accept: {

# App Store Connect — Vogel Metadata

App Store Connect → Apps → Vogel → Distribution → App Store sayfasında girilecekler.
...
### Promotional Text (170 chars — App Store'da güncelleme yapmadan değiştirebilirsin)
```
Master German with bite-sized lessons, speaking practice, and a streak system that keeps you motivated every day.
```
...
### Support URL
```
https://github.com/samettrm/Vogel
```

### Marketing URL (opsiyonel)
```
https://samettrm.github.io/Vogel
```
...
## Localization: Turkish (TR) — Opsiyonel ama önerilir
...
| **Made for Kids** | **No** (4+ ama "Made for Kids" değil) |
...
## GitHub Pages Aktifleştirme (Privacy Policy URL için)

1. github.com/samettrm/Vogel → Settings → Pages
...
## App Store Connect'te Review Bilgileri
